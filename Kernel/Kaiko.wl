...
BeginPackage["KirillBelov`ExchangeLink`Kaiko`"]
...
KaikoOHLCVHist::usage =
"KaikoOHLCVHist[assoc]
KaikoOHLCVHist[assoc, {opts}]
KaikoOHLCVHist[exchangeCode, instrumentClass, instrumentCode]
KaikoOHLCVHist[exchangeCode, instrumentClass, instrumentCode, {opts}]
...
KaikoOHLCVHist[exchangeCode_String, instrumentClass_String, instrumentCode_String,
	opts: OptionsPattern[{KaikoOHLCVHist, kaikoMarketDataAPI}]] :=
	Query["data", All, <|
		"timestamp" -> Function[FromUnixTime[#timestamp/1000]], 
	...
	kaikoMarketDataAPI["v2", "trades.v1", "exchanges", exchangeCode, instrumentClass, instrumentCode, "aggregations", "ohlcv",
		getOptions[KaikoOHLCVHist, opts], getOptions[kaikoMarketDataAPI, opts]]


Options[KaikoOHLCVRecent] = {
	"limit" -> Automatic,
	"interval" -> Automatic
}


KaikoOHLCVRecent[exchangeCode_String, instrumentClass_String, instrumentCode_String,
	opts: OptionsPattern[{KaikoOHLCVRecent, kaikoMarketDataAPI}]] :=
	Query["data", All, <|
		"timestamp" -> Function[FromUnixTime[#timestamp/1000]],
		"open" -> "open" /* ToExpression,
		"high" -> "high" /* ToExpression,
	...
	kaikoMarketDataAPI["v1", "trades.v1", "exchanges", exchangeCode, instrumentClass, instrumentCode, "aggregations", "ohlcv", "recent",
		getOptions[KaikoOHLCVRecent, opts], getOptions[kaikoMarketDataAPI, opts]]


Options[KaikoVWAPHist] = {
	"startTime" -> Automatic, 
	"endTime" -> Automatic, 
	"continuationToken" -> Automatic, 
	"pageSize" -> Automatic, 
...
KaikoVWAPHist[exchangeCode_String, instrumentClass_String, instrumentCode_String,
	opts: OptionsPattern[{KaikoVWAPHist, kaikoMarketDataAPI}]] :=
	Query["data", All, <|
		"timestamp" -> Function[FromUnixTime[#timestamp/1000]], 
		"open" -> "open" /* ToExpression, 
		"high" -> "high" /* ToExpression, 
	...
	|>] @ 
	kaikoMarketDataAPI["v2", "trades.v1", "exchanges", exchangeCode, instrumentClass, instrumentCode, "aggregations", "ohlcv",
		getOptions[KaikoVWAPHist, opts], getOptions[kaikoMarketDataAPI, opts]]


Options[KaikoVWAPRecent] = {
	"startTime" -> Automatic, 
	"endTime" -> Automatic, 
	"continuationToken" -> Automatic, 
	"pageSize" -> Automatic, 
...
KaikoVWAPRecent[exchangeCode_String, instrumentClass_String, instrumentCode_String,
	opts: OptionsPattern[{KaikoVWAPHist, KaikoVWAPRecent}]] :=
	Query["data", All, <|
		"timestamp" -> Function[FromUnixTime[#timestamp/1000]], 
		"open" -> "open" /* ToExpression, 
		"high" -> "high" /* ToExpression, 
	...
	|>] @ 
	kaikoMarketDataAPI["v2", "trades.v1", "exchanges", exchangeCode, instrumentClass, instrumentCode, "aggregations", "ohlcv",
		getOptions[KaikoVWAPRecent, opts], getOptions[kaikoMarketDataAPI, opts]]
